...
\begin{enumerate}
	...
	\item Ne vous souciez pas des détails. Même avec des erreurs d'orthographe, Google propose automatiquement une correction. Aussi, ce n'ai pas nécessaire de respecter le majuscule: rechercher \expword{Alger} est le même que rechercher \expword{alger}.
