...
%	\rotatebox[origin=c]{90}{Windows 10 Mobile (Microsoft)} &
...
%\frametitle{Environnement de travail distant}
%
%Selon l'emplacement du serveur, le réseau 
%
%\end{frame}
...
\begin{itemize}
	...
	\item une version simple du masque: là où il y a un \keyword{255} (sous réseau), là où il y a 0 (hôte)
...
\textwidth]{../img/Bweb01-environnement/url.pdf}
...
\begin{itemize}
	\item \keyword{HTTP} (Hypertext Transfer Protocol): transfert hypertexte pour naviguer sur le web  (HTTPS pour la
	version sécurisée)
	\item \keyword{FTP} (File Transfer Protocol): transfert des fichiers
	\item \keyword{SMTP} (Simple Mail Transport Protocol): envoi et réception du courrier électronique
	\item \keyword{DNS} (Domain Name System): transformation d'un URL vers une adresse IP
	\item \keyword{DHCP} (Dynamic Host Configuration protocol): affectation des adresses IP à des clients (hôtes)
\end{itemize}
...
\includegraphics[width=
\textwidth]{../img/Bweb01-environnement/access-web.pdf}
